document.addEventListener('DOMContentLoaded', function () {
    // This can be adjusted to center on your specific counties
    ...
    const attributeConfigs = {
        'farmInfo': {
            ...
            attributes: {
                'F1': { 
                    label: 'No of Farms', 
                    grades: [0, 100, 250, 500, 750, 1000, 1500], 
                    colors: ['#edf8e9', '#c7e9c0', '#a1d99b', '#74c476', '#41ab5d', '#238b45', '#005a32'] 
                },
                'F2': { 
                    label: 'Land in farms (acres)', 
                    grades: [0, 10000, 25000, 50000, 100000, 200000, 400000], 
    ...
    info.update = function(props) {
        let content = '<h4>2022 County Farm Data</h4>';
    ...
    uiControls.onAdd = function() {
        ...
        // --- INTEGRATED FIX: This stops all mouse events on the checkbox container from reaching other elements. ---
    ...
    fetch('/Geojson_Data/2022/County/Farm_Data.geojson')
        .then(res => {
