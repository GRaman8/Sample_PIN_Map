document.addEventListener('DOMContentLoaded', function () {
    ...
    const attributeConfigs = {
        'totalPopulation': {
            ...
            attributes: {
                'T1': { 
                    label: 'Total Population', 
                    grades: [0, 5000, 15000, 30000, 60000, 100000, 200000], 
        ...
        'age': {
            ...
            attributes: {
                ...
                'A2': { 
                    ...
                    grades: [0, 4000, 10000, 20000, 40000, 80000, 150000], 
                    colors: ['#F7FBFF', '#DEEBF7', '#C6DBEF', '#9ECAE1', '#6BAED6', '#4292C6', '#2171B5', '#084594'] 
                },
                'A3': { 
                    label: '65 years and over', 
                    grades: [0, 500, 2000, 5000, 10000, 15000, 25000], 
        ...
        'race': {
            ...
            attributes: {
                'R1': { label: 'White', grades: [0, 4000, 10000, 25000, 50000, 90000, 150000], colors: ['#f7f4f9', '#e7e1ef', '#d4b9da', '#c994c7', '#df65b0', '#e7298a', '#ce1256', '#91003f'] },
                'R2': { label: 'Black or African American', grades: [0, 1000, 5000, 15000, 30000, 50000, 100000], colors: ['#f7fcfd', '#e0ecf4', '#bfd3e6', '#9ebcda', '#8c96c6', '#8c6bb1', '#88419d', '#6e016b'] },
                'R3': { label: 'American Indian & Alaska Native', grades: [0, 10, 50, 100, 250, 500, 1000], colors: ['#f7fcf5', '#e5f5e0', '#c7e9c0', '#a1d99b', '#74c476', '#41ab5d', '#238b45', '#00441b'] },
                'R4': { label: 'Asian', grades: [0, 100, 500, 2000, 5000, 10000, 25000], colors: ['#fcfbfd', '#efedf5', '#dadaeb', '#bcbddc', '#9e9ac8', '#807dba', '#6a51a3', '#4a1486'] },
                'R5': { label: 'Native Hawaiian & Pacific Islander', grades: [0, 5, 10, 25, 50, 100, 200], colors: ['#fff5eb', '#fee6ce', '#fdd0a2', '#fdae6b', '#fd8d3c', '#f16913', '#d94801', '#8c2d04'] },
                'R6': { label: 'Two or More Races', grades: [0, 100, 500, 1500, 3000, 7000, 15000], colors: ['#fff7fb', '#ece2f0', '#d0d1e6', '#a6bddb', '#67a9cf', '#3690c0', '#02818a', '#016450'] }
            }
        },
        'income': {
            label: 'Median Income',
            attributes: {
                'I1': { label: 'Median Household Income ($)', grades: [0, 30000, 45000, 60000, 75000, 90000, 120000], colors: ['#ffffd4', '#fee391', '#fec44f', '#fe9929', '#d95f0e', '#993404', '#662506'] }
            }
        },
        'education': {
            label: 'Education Level',
            attributes: {
                'B1': { label: 'Bachelor\'s Degree', grades: [0, 500, 1500, 4000, 8000, 15000, 30000], colors: ['#f1eef6', '#d7b5d8', '#df65b0', '#dd1c77', '#980043'] },
                'B2': { label: 'Bachelor\'s Degree or Higher', grades: [0, 1000, 3000, 7000, 15000, 30000, 50000], colors: ['#dff3fe', '#a7dcfd', '#61b9f7', '#228be6', '#1c7ed6', '#1971c2'] }
            }
        }
    };
    ...
    info.update = function(props) {
        let content = '<h4>2022 Georgia Counties Demographic Data</h4>';
        const locationName = props ? props.NAMELSAD : 'Click a County for details';
        ...
        } else content += 'Click a County for details';
    ...
    uiControls.onAdd = function() {
        ...
        // --- DEFINITIVE FIX: This stops all mouse events on the checkbox container from reaching other elements. ---
        ...
        L.DomEvent.on(detailsToggleContainer.querySelector('#details-toggle'), 'change', function(e) {
            ...
            // --- ADDED LOGIC: Force hide all dropdowns when checkbox is used ---
            document.querySelectorAll('.attribute-selector-container').forEach(sel => sel.style.display = 'none');
    ...
    fetch('/Geojson_Data/2022/County/Race_TP_county.geojson')
        .then(res => {
            ...
            geojsonLayer = L.geoJSON(data, {
                ...
                onEachFeature: (feature, layer) => {
                    ...
                    layer.bindPopup(() => {
                        ...
                        let content = `<div class="popup-header">${props.NAMELSAD || 'Unknown County'}</div>`;
