document.addEventListener('DOMContentLoaded', function () {
    ...
    // This is the data configuration for your 2022 State-level Farm Data map
    const attributeConfigs = {
        'farmInfo': {
            ...
            attributes: {
                'F1': { 
                    label: 'No of Farms', 
                    grades: [0, 20000, 40000, 60000, 80000, 100000, 150000], 
                    colors: ['#edf8e9', '#c7e9c0', '#a1d99b', '#74c476', '#41ab5d', '#238b45', '#005a32'] 
                },
                'F2': { 
                    label: 'Land in farms (acres)', 
                    grades: [0, 5000000, 15000000, 30000000, 50000000, 70000000, 90000000], 
    ...
    info.update = function(props) {
        let content = '<h4>2022 State Farm Data</h4>';
    ...
    fetch('/Geojson_Data/2022/State/Farm_Data.geojson')
        .then(res => {
